...
{block name='category'}
    <section class="ru-results-intro ru-results-hero">
        <div class="ru-eyebrow">{l s='Available stays'}</div>
        <h1>{l s='Choose a room for your stay'}</h1>
        <p>{l s='Compare room details, guest capacity and prices for your selected dates.'}</p>
    </section>
    <div class="row cat_cont ru-results-shell">
        <div class="col-sm-12">
            {block name='category_top_left'}
                <div class="row margin-lr-0 catSortBlock ru-results-toolbar">
