...
<!--[if gt IE 8]> <html class="no-js ie9"{if isset($language_code) && $language_code} lang="{$language_code|escape:'html':'UTF-8'}"{/if}><![endif]-->
	...
	<head>
		...
		{if isset($css_files)}
			...
			{/foreach}
		{/if}
		<link rel="stylesheet" href="{$css_dir}rural-up.css" type="text/css" media="all" />
						...
						<div class="header-top">
							<div class="container">
								<div class="row">
									<div class="col-xs-12">
										<div class="col-xs-7">
											<a class="ru-brand" href="{if isset($force_ssl) && $force_ssl}{$base_dir_ssl}{else}{$base_dir}{/if}" title="{$shop_name|escape:'html':'UTF-8'}">Rural UP<small>{l s='Stays beyond the city'}</small></a>
										</div>
										<div class="col-xs-5">
											<div class="ru-header-actions">
												<a class="ru-help" href="{$link->getPageLink('contact-form')}"><svg class="ru-svg-icon" aria-hidden="true"><use href="{$img_dir}rural-up-icons.svg#ru-icon-phone"></use></svg>{l s='Need help?'}</a>
											</div>
										</div>
