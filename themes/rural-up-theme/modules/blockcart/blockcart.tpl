	...
	{/if}
		{block name='blockcart_shopping_cart'}
			<div class="shopping_cart">
				<a class="ru-cart-control" href="{$link->getPageLink($order_process, true)|escape:'html':'UTF-8'}" title="{l s='View my booking cart' mod='blockcart'}" rel="nofollow">
					<svg class="ru-svg-icon" aria-hidden="true"><use href="{$img_dir}rural-up-icons.svg#ru-icon-cart"></use></svg>
					<span class="ru-cart-label">{l s='Cart' mod='blockcart'}</span>
					...
					<svg class="ru-svg-icon ru-cart-chevron" aria-hidden="true"><use href="{$img_dir}rural-up-icons.svg#ru-icon-chevron-down"></use></svg>
															...
															<td class="delete">
																{if strlen($discount.code)}
																	<a class="delete_voucher" href="{$link->getPageLink("$order_process", true)}?deleteDiscount={$discount.id_discount|intval}" title="{l s='Delete' mod='blockcart'}" rel="nofollow">
																						<svg class="ru-svg-icon" aria-hidden="true"><use href="{$img_dir}rural-up-icons.svg#ru-icon-close"></use></svg>
																	</a>
																{/if}
															</td>
														</tr>
									...
									{block name='blockcart_shopping_cart_checkout_action'}
										<p class="cart-buttons">
											<a id="button_order_cart" class="btn btn-default button button-small" href="{$link->getPageLink("$order_process", true)|escape:"html":"UTF-8"}" title="{l s='Check out' mod='blockcart'}" rel="nofollow">
												<span>
													{l s='Check out' mod='blockcart'}<svg class="ru-svg-icon ru-button-icon" aria-hidden="true"><use href="{$img_dir}rural-up-icons.svg#ru-icon-arrow-right"></use></svg>
												</span>
											</a>
										</p>
									{/block}
						...
						<div class="layer_cart_product col-xs-12 col-md-6">
							...
							{block name='blockcart_layer_cart_left_heading'}
								<h2 class="layer_cart_room_txt">
									<svg class="ru-svg-icon ru-feedback-icon" aria-hidden="true"><use href="{$img_dir}rural-up-icons.svg#ru-icon-check"></use></svg>{l s='Room successfully added to your cart' mod='blockcart'}
								</h2>
								<h2 class="layer_cart_product_txt">
									<svg class="ru-svg-icon ru-feedback-icon" aria-hidden="true"><use href="{$img_dir}rural-up-icons.svg#ru-icon-check"></use></svg>{l s='Product successfully added to your cart' mod='blockcart'}
								</h2>
							{/block}
								...
								{block name='blockcart_layer_cart_actions'}
									<div class="button-container">
										<span class="continue btn btn-default button exclusive-medium" title="{l s='Continue browsing' mod='blockcart'}">
											<span>
																			<svg class="ru-svg-icon ru-button-icon ru-button-icon--left" aria-hidden="true"><use href="{$img_dir}rural-up-icons.svg#ru-icon-arrow-left"></use></svg>{l s='Continue browsing' mod='blockcart'}
											</span>
										</span>
										<a class="btn btn-default button button-medium"	href="{$link->getPageLink("$order_process", true)|escape:"html":"UTF-8"}" title="{l s='Proceed to checkout' mod='blockcart'}" rel="nofollow">
											<span>
																		{l s='Proceed to checkout' mod='blockcart'}<svg class="ru-svg-icon ru-button-icon" aria-hidden="true"><use href="{$img_dir}rural-up-icons.svg#ru-icon-arrow-right"></use></svg>
											</span>
										</a>
									</div>
								{/block}
