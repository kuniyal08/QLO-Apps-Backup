...
{block name='user_navigation'}
    ...
    {/if}
            ...
            <ul class="navbar-nav hidden-xs">
                <li class="dropdown">
                    <button class="btn dropdown-toggle" type="button" id="user_info_acc" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
                        ...
                        <span class="account_user_name visi_xs"><svg class="ru-svg-icon" aria-hidden="true"><use href="{$img_dir}rural-up-icons.svg#ru-icon-user"></use></svg></span>
                        <svg class="ru-svg-icon ru-account-chevron" aria-hidden="true"><use href="{$img_dir}rural-up-icons.svg#ru-icon-chevron-down"></use></svg>
                    </button>
        ...
        {else}
			<a class="header-top-link ru-account-control" href="{$link->getPageLink('my-account', true)|escape:'html'}" rel="nofollow" title="{l s='Log in to your customer account' mod='blockuserinfo'}">
				<svg class="ru-svg-icon" aria-hidden="true"><use href="{$img_dir}rural-up-icons.svg#ru-icon-user"></use></svg>
                <span class="hide_xs">{l s='Sign in' mod='blockuserinfo'}</span>
                <span class="visi_xs"><svg class="ru-svg-icon" aria-hidden="true"><use href="{$img_dir}rural-up-icons.svg#ru-icon-user"></use></svg></span>
            </a>
        {/if}
    {if !isset($ajaxCustomerLogin)}
        </div>
