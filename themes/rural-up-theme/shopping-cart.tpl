...
<section class="ru-checkout-intro">
	<div class="ru-eyebrow">{l s='Your booking'}</div>
	<h1>{l s='Review your stay'}</h1>
	<p>{l s='Your room, dates and selected extras are held while you complete your booking.'}</p>
</section>
